...
<html lang="en" class="no-js">
   <head>
      <!-- Meta -->
      <title>Local Untold Stories</title>
      <meta charset="UTF-8">
       ...
       <div class="container studio">
         ...
         <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12 wow fadeInDown">
               ...
               <h1>Explore Everyday Kibera - Youths in Community.</h1>

               <a href="#" class="fa fa-facebook"></a>
                  <a href="#" class="fa fa-twitter"></a><b>Latest Stories<h2> Reclaiming art spaces</h2></b>
      ...
      <div class="container">
         <div class="row">
            <div class="col-xl-5 col-md-7 col-sm-12">
               <img class="img-fluid" src="img/photo1-1.jpg" alt="Photo">
